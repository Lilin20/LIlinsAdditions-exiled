...
public class PlaceSwap : CustomWeapon
{
    ...
    protected override void OnShot(ShotEventArgs ev)
    {
        ...
        Timing.CallDelayed(SWAP_DELAY,
            () => ExecutePositionSwap(ev.Player, ev.Target, shooterPosition, targetPosition));
    }
    ...
    private static void ExecutePositionSwap(Player shooter, Player target, Vector3 shooterPosition,
