...
public class RussianRoulette : CustomWeapon
{
    ...
    private static void ResolveRoulette(Exiled.API.Features.Player shooter, Exiled.API.Features.Player target,
        float roll)
    {
    ...
    private static bool ValidatePlayersForRoulette(Exiled.API.Features.Player shooter,
        Exiled.API.Features.Player target)
    {
