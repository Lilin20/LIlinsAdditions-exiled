...
namespace LilinsAdditions.Main.Items.Weapons.Shotguns;
...
public class BreachShotgun : CustomWeapon
{
    ...
    protected override void OnShot(ShotEventArgs ev)
    {
        ...
        if (TryGetTargetDoor(ev.Player, out var door)) BreakDoor(door);
    }

    private bool TryGetTargetDoor(Player player, out Door door)
    {
        door = null;
    ...
    {
        if (door is BreakableDoor breakableDoor) breakableDoor.Break();
    }
}